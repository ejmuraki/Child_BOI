...
ggcorrplot(corr_results_ling, type = "upper", lab = TRUE, lab_size = 6, tl.cex = 16, outline.col = "white", ggtheme = ggplot2::theme_bw, colors = c("#f8766d", "white", "#00bfc4"))

ggsave("figures/Figure3.png", width = 15, height = 15)

ggcorrplot(corr_results_sem, type = "upper", lab = TRUE, lab_size = 8, tl.cex = 20, outline.col = "white", ggtheme = ggplot2::theme_bw, colors = c("#f8766d", "white", "#00bfc4"))
